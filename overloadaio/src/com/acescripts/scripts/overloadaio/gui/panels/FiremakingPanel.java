...
public class FiremakingPanel extends JPanel {
    ...
    /** they're stored somewhere else 2 secs
     * 2 secs
     * MAIN OPTIONS
     */
    ...
    public FiremakingPanel(OverloadAIO script) {
        ...
        addTaskButton.addActionListener(e -> {
            ...
            script.getTasks().add(new FiremakingTask(script, logTypeComboBox.getSelectedItem().toString(), Integer.parseInt(desiredGoalTextField.getText()), taskType, FiremakingLocations.valueOf(firemakingLocationComboBox.getSelectedItem().toString()).getArea(), getPaths(script, firemakingLocationComboBox.getSelectedItem().toString())));
        });
