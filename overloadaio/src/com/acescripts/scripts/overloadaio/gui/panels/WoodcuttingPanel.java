...
public class WoodcuttingPanel extends JPanel {
    ...
    public WoodcuttingPanel(OverloadAIO script) {
        ...
        addTaskButton.addActionListener(e -> {
            ...
            script.getTasks().add(new WoodcuttingTask(script,
                    Tree.valueOf(treeTypeComboBox.getSelectedItem().toString()).getTreeName(),
                    Integer.parseInt(desiredGoalTextField.getText()),
                    taskType,
                    WoodcuttingLocations.valueOf(woodcuttingLocationComboBox.getSelectedItem().toString()).getArea(),
                    bankingEnabled)
            );
        });
